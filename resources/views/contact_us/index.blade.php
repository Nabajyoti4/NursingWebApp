...
{{--                            <h3 class="font-weight-bold p-3 text-white">Feel free to contact us any time for any--}}
{{--                                Queries</h3>--}}
                            <h1 class="mb-0 p-2 text-uppercase font-weight-bold text-white">
                                AAROGYA HOME CARE NURSING SERVICE</h1>
                            <h3 class="font-weight-bold p-3 text-white">A Unit of GIYANMOY FOUNDATION registered under
                                Section 8 of Companies Act 2013</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container-nurserequest mb-5" id="joinForm">
                <div class="wrap-nurserequest " data-aos="flip-down" data-aos-delay="200">
					...
					Send Any Queries , We will Respond You soon
                        ...
                        <div class="wrap-input100 ">
                            <textarea class="input100" type="text" name="query" placeholder="Message"
                                      required></textarea>
                            <span class="focus-input100"></span>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-4 mt-5 mt-lg-0" data-aos="flip-up" data-aos-delay="200">
                        <div class="address-location h-100">
                            ...
                            <ul class="p-0 m-0">
                                <li>Old Amalapatty, Ganak Patty, By Lane, Harakanta Nazir Path Sivasagar-785640,
                                    Assam.
                                </li>
                    ...
                    <div class="col-12 col-md-4 mt-5 mt-lg-0" data-aos="flip-right" data-aos-delay="200">
                        <div class="address-location h-100">
                            ...
                            <ul class="p-0 m-0">
                                <li>Sashan Para Road, Near Sankar Dev Hospital, Mancotta Road, Dibrugarh-786003 Assam.
                                </li>
        ...
        <div class="col-12 probootstrap-animate p-3" align="center">
            <div id="map" class=" container">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3562.767342342199!2d94.18186801447968!3d26.751799583197204!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3746c3ceb2bc28f7%3A0x8ad690dd9028fe34!2sAAROGYA%20HOME%20CARE%20SERVICE!5e0!3m2!1sen!2sin!4v1580747838248!5m2!1sen!2sin"
