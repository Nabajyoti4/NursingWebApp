                    ...
                    <div class="col-md-4" >
                        <div class="profile-img">
                            <img src="{{ $user->photo?asset("/storage/".$user->photo->photo_location) :'No Photo'}}"
                                 alt=""  style="width: 280px; height: 280px; object-fit: cover;"/>
                        </div>
                    </div>
                        ...
                        <div class="tab-content profile-tab" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <p>{{$user->current_address_id? $user->address($user->getCAddressId($user->id))->city : "No city"}}</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <p>{{$user->current_address_id? $user->address($user->getPAddressId($user->id))->city : "No city"}}</p>
                                    </div>
                                </div>
